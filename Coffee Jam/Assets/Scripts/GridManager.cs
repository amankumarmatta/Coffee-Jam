...
public class GridManager : MonoBehaviour
{
    ...
    public float zPosition = 0f; // All trays on same Z plane
    ...
    void GenerateGrid()
    {
        ...
        // Calculate grid starting position (center)
    ...
    void SpawnTray(Vector2Int gridPos, int trayType)
    {
        ...
        {
            Renderer renderer = tray.GetComponentInChildren<Renderer>();
            if (renderer != null) renderer.material.color = trayColors[trayType];
        }
